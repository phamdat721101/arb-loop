...
cat <<EOF
   ...
   ── arb-loop v0.0 simple ship (FEATURE_ARBLOOP_SIMPLE) ──
   • smoke:arbloop-gasless-publish  (PRD-E — seller signs once, relayer pays gas)
   • smoke:arbloop-x402             (PRD-A — 402 challenge → sign → 200 + settlement tx)
