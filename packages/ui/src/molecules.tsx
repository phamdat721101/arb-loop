...
const TIER_DETAIL: Record<Tier, { headline: string; sub: string; bullets: string[] }> = {
  ...
  trustless: {
    ...
    bullets: [
      'Fhenix CoFHE threshold network (9 validators, 3 jurisdictions)',
      'EigenDA hot lane + Arweave permanent (v0.1 deferred)',
...
const MIGRATION_STEPS = [
  ...
  { label: 'Uploading to target storage', description: 'Pinata IPFS or platform store' },
